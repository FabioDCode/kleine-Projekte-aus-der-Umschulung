...
namespace Modul24.Tamagotchi
{
    internal class Tamagotchi
    {
        // Lock damit es auf Win11 Konsole nicht springt da die Win11 Konsole pixelbasiert arbeitet
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
        // Hier ist die Heilung geregelt nötig da der Tamagotchi sonst 100% stribt
        public void Heal()
        {
            if (!alive) return;
        ...
        public void IsHangry(Food food)
        {
            ...
            // Lock damit das Programm nicht springt
            lock (consoleLock)
            {
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
        // Zufällige Ereignisse damit der Tamagotchi Leben verliert.
        public void Ereignisse()
        {
            ...
            lock (consoleLock)
            {
                switch (zufall)
                {
                    ...
                    case 78:
                        Console.SetCursorPosition(0, 2);
                        Console.WriteLine($"{Name} hat NRW verbot bekommen von Manuellsen.   ");
                        Lebenspunkte -= 30;
                        Freude -= 20;
                        break;
                    case 1:
                        Console.SetCursorPosition(0, 2);
                        Console.WriteLine($"{Name} hat 10 Liegestütze gemacht.               ");
                        Hunger -= 15;
                        Freude -= 10;
                        break;
                }
    ...
    internal class Gameloop
    {
        static void Main(string[] args)
        {
            ...
            lock (Tamagotchi.consoleLock)
            {
                Console.WriteLine($"Ein neuer Tamagotchi namens {kim.Name} ist geboren!");
            }
            ...
            {   // Anzeige für den Spieler welche Möglichkeiten er hat
                ...
                char eingabe = Console.ReadKey().KeyChar;                               // KeyChar gibt das durch die gedrückte Taste dargestellte Zeichen zurück

                switch (eingabe)                                                        // switch für die einzelnen Funktionen
                {
                    ...
                    case '4':
                        ...
                        {
                            Console.SetCursorPosition(0, 18);
                            Console.WriteLine($"Du hast {kim.Name} geschockt mit dem Schockhalsband.");
                        }
                        break;
                    case '5':
                        kim.Heal();
